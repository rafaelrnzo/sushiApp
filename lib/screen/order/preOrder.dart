...
class PreOrderDetail extends StatefulWidget {
  const PreOrderDetail({Key? key}) : super(key: key);

  @override
  State<PreOrderDetail> createState() => _PreOrderDetailState();
}

class _PreOrderDetailState extends State<PreOrderDetail> {
                      ...
                      child: Column(
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              Text(
                                "Jl.Ranco Indah no.66,faris bakti,Jalur Ranco,India,Indonesia",
                                style: TextStyle(
